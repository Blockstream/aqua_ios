...
class DropAlert: UIView {
    ...
    func success(message: String, delay: Double = 2.0) {
        alert(with: message, textColor: .white, backgroundColor: .green, delay: delay)
    }

    func info(message: String, delay: Double = 2.0) {
        alert(with: message, textColor: .white, backgroundColor: .blue, delay: delay)
    }

    func warning(message: String, delay: Double = 2.0) {
        alert(with: message, textColor: .white, backgroundColor: .yellow, delay: delay)
    }

    func error(message: String, delay: Double = 2.0) {
        alert(with: message, textColor: .white, backgroundColor: .red, delay: delay)
    }
